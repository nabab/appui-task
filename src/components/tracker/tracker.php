    ...
    <div class="bbn-overlay">
      <div class="appui-task-tracker-list bbn-w-100 bbn-flex-height">
        ...
        <div class="bbn-flex-fill bbn-flex-height">
          <div bbn-if="active"
               class="bbn-block">
            <div class="bbn-header bbn-no-border-top bbn-no-border-left bbn-no-border-right bbn-xspadding">
              <div class="bbn-flex-width">
                <div class="bbn-flex-fill bbn-b bbn-hspadding"><?=_('In progress')?></div>
                <div bbn-if="progress"
                     class="bbn-b bbn-hspadding"
                     bbn-text="progress"/>
              </div>
            </div>
            <div class="bbn-primary">
              <div class="bbn-flex-width bbn-vmiddle bbn-vxspadding">
                <div bbn-text="shorten(getField(list, 'title', 'id', active.id_task))"
                     class="bbn-flex-fill bbn-p bbn-b bbn-hspadding"
          ...
          <div class="bbn-flex-fill">
            <bbn-scroll>
              <div bbn-for="(l,i) in realList"
                   :class="['bbn-vxspadding', 'bbn-hspadding', 'bbn-no-border-left', 'bbn-no-border-right', {'bbn-alt': i%2}]">
